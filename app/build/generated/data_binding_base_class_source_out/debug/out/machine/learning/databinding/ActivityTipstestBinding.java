...
public final class ActivityTipstestBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityTipstestBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
      @NonNull TextView count, @NonNull ConstraintLayout drawerLayout, @NonNull TextView question,
      @NonNull RadioButton radioButton1, @NonNull RadioButton radioButton2,
      @NonNull RadioButton radioButton3, @NonNull RadioButton radioButton4,
      @NonNull RadioGroup radios, @NonNull ImageView smile) {
  ...
  @NonNull
  public static ActivityTipstestBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTipstestBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_tipstest, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTipstestBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.smile;
      ImageView smile = ViewBindings.findChildViewById(rootView, id);
      if (smile == null) {
        break missingId;
      }

      return new ActivityTipstestBinding((ConstraintLayout) rootView, button, count, drawerLayout,
          question, radioButton1, radioButton2, radioButton3, radioButton4, radios, smile);
    }
